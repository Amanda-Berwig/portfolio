        ...
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row gap-8">
          ...
          <div className="md:w-2/3 bg-gray-50 p-8 rounded-lg shadow-md">
            ...
            <form>
              ...
              <button
                type="submit"
                className="px-6 py-3 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition duration-300 w-full md:w-auto"
              >
                Enviar Mensagem
              </button>
            </form>
            ...
            <div className="bg-gray-50 p-8 rounded-lg shadow-md">
              ...
              <div className="flex space-x-4">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 text-white p-3 rounded-full hover:from-purple-600 hover:via-pink-600 hover:to-red-600 transition duration-300"
                >
                  <svg
                    className="w-6 h-6"
                    fill="currentColor"
